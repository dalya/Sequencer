        ...
        if len(objects_list[0].shape) == 1:
            ...
            for i in range(n_obj):
                for j in range(n_obj):
                    ...
                    obj_i_small = obj_i[(obj_i != 0) & (obj_j != 0)]
                    obj_j_small = obj_j[(obj_i != 0) & (obj_j != 0)]

                    distance_matrix[i, j] = entropy(obj_i_small, obj_j_small)        
...
def kl_simple_2D(objects_list, index_pair):
    ...
    return entropy(obj_i_small, obj_j_small)
